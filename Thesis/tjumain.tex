...
\pagenumbering{Roman}
\input{preface/abstract}                             % 摘要

%%%%%%%%%%   目录   %%%%%%%%%%
\titleformat{\chapter}{\centering\xiaosan\hei}{\chaptername}{2em}{} % 设置目录两字的格式
...
\phantomsection
\markboth{参考文献}{参考文献}
\addcontentsline{toc}{appendix}{参考文献}       % 参考文献加入到中文目录
\nocite{*}                                     % 若将此命令屏蔽掉，则未引用的文献不会出现在文后的参考文献中
\bibliography{references/reference}
\titleformat{\chapter}{\centering\xiaosan\hei}{\chaptername}{2em}{}
\include{appendix/appendixs}                   % 附录
