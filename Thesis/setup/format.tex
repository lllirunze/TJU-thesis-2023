...
\titlecontents{chapter}[2em]{\vspace{.25\baselineskip}\xiaosi\hei}
             {\thecontentslabel\quad\song}{}
             {\hspace{.5em}\titlerule*[10pt]{$\cdot$}\xiaosi\contentspage}
\titlecontents{section}[3em]{\vspace{.25\baselineskip}\xiaosi\hei}
             {\thecontentslabel\quad\song}{}
             {\hspace{.5em}\titlerule*[10pt]{$\cdot$}\xiaosi\contentspage}
\titlecontents{subsection}[4em]{\vspace{.25\baselineskip}\xiaosi\hei}
             {\thecontentslabel\quad\song}{}
             {\hspace{.5em}\titlerule*[10pt]{$\cdot$}\xiaosi\contentspage}
\titlecontents{appendix}[2em]{\vspace{.25\baselineskip}\xiaosi\song}
             {\thecontentslabel\quad\song}{}
             {\hspace{.5em}\titlerule*[10pt]{$\cdot$}\xiaosi\contentspage}
...
\titleformat{\chapter}{\centering\xiaosan\hei}{\hei\chaptername}{2em}{}
...
\chapter*{\centering\erhao\song{\bf{摘\quad 要}}}
\song\defaultfont
\@cabstract
\vspace{\baselineskip}
